...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (email === 'admin@gmail.com' && password === 'admin123') {
      localStorage.setItem('mockAdminSession', 'active');
      window.dispatchEvent(new Event('storage')); // Trigger context update manually
      router.push('/admin');
    } else {
      setError('Invalid credentials. (Hint: admin@gmail.com / admin123)');
    }
