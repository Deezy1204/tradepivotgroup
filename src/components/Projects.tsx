...
export default function Projects() {
  ...
  useEffect(() => {
    ...
    const mockProjects: Project[] = [
      {
        id: "mock-1",
        title: "Harare Residential Complex",
        location: "Harare, Zimbabwe",
        size: "15,000 sqm",
        status: "Completed",
        description: "A modern luxury residential complex featuring 40 bespoke apartments with state-of-the-art amenities and sustainable design principles.",
        longDesc: "This landmark project redefined urban living in Harare. The complex includes multi-level parking, a central courtyard, and energy-efficient systems. We delivered this project 2 months ahead of schedule while maintaining the highest quality standards.",
        image: placeholderImages[0]
      },
      {
        id: "mock-2",
        title: "Bulawayo Logistics Hub",
        location: "Bulawayo, Zimbabwe",
        size: "25,000 sqm",
        status: "In Progress",
        description: "A major commercial logistics facility designed to streamline distribution operations across the southern region.",
        longDesc: "Featuring expansive warehouse spaces, advanced cold storage capabilities, and automated docking systems. The structural design accounts for heavy machinery operation and provides optimized workflow paths for maximum efficiency.",
        image: placeholderImages[1]
      },
      {
        id: "mock-3",
        title: "Victoria Falls Resort Extension",
        location: "Victoria Falls, Zimbabwe",
        size: "8,500 sqm",
        status: "Completed",
        description: "A premium extension to a world-class resort, blending contemporary architecture with the surrounding natural landscape.",
        longDesc: "The project involved constructing 20 new luxury suites, a panoramic viewing deck, and a world-class spa facility. Careful planning was required to minimize disruption to natural wildlife and existing guests during the construction phase.",
        image: placeholderImages[2]
      },
      {
        id: "mock-4",
        title: "Mutare Commercial Plaza",
        location: "Mutare, Zimbabwe",
        size: "12,000 sqm",
        status: "Planning",
        description: "A mixed-use commercial center offering prime retail and office spaces in the heart of the city.",
        longDesc: "Designed with a focus on natural light and open public spaces. The plaza will feature a glass-canopy atrium, smart building management systems, and a green roof to improve thermal performance and aesthetic appeal.",
          ...
          >
            ...
            >
                ...
                <div 
                    ...
                    className="md:w-3/5 h-[40vh] md:h-full relative bg-[var(--card-bg)] shrink-0 group cursor-zoom-in overflow-hidden"
                >
                    <Image 
                ...
                <div 
                    className="md:w-2/5 flex-1 flex flex-col overflow-y-auto scroll-smooth custom-scrollbar"
                    data-lenis-prevent="true"
                >
                    <div className="p-8 md:p-16 pb-24 md:pb-32">
                        <div className="flex items-center gap-4 text-[11px] uppercase font-black tracking-[0.4em] text-silver-primary mb-8">
                            <MapPin size={14} /> {selectedProject.location}
                        </div>
                        
                        <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter leading-[0.9] text-[var(--foreground)] mb-8">
