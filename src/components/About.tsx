        ...
        <div className="flex flex-col gap-24">
          ...
          <div className="flex flex-col md:flex-row items-end justify-between gap-8 border-b border-[var(--border-subtle)] pb-12 overflow-hidden">
            ...
            >
                ...
                <button className="text-[11px] font-black uppercase tracking-[0.3em] text-[var(--foreground)] border-b border-[var(--foreground)]/20 pb-2 hover:border-[var(--foreground)] transition-all">
                    About Company
                </button>
            </motion.div>
          </div>
